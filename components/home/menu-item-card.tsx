...
export default function MenuItemCard({ item }: { item: MenuItem }) {
  return (
    <div className="group overflow-hidden rounded-xl border border-amber-900/20 bg-gradient-to-br from-amber-950 to-[#151515] shadow-sm transition-shadow hover:shadow-md">
